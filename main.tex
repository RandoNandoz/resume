...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \textbf{Developer Tools}{: Git, Docker, Azure, CloudFlare, Linux, Interactive Disassembler, Cisco Wireless, Hyper-V, VMware ESXi, gdb/lldb, Valgrind Memcheck, C++ Sanitizers (ASAN/MSAN/TSAN)} \\
