...
\resumeSubheading
{Undergraduate Teaching Assistant (Intro to SE; Intro to Computer Systems)}{July 2024 -- Present}
...
\resumeItemListStart
\resumeItem{ExploTest is a tool used to generate unit tests from system-level integration tests. It captures procedure calls during whole-program execution and creates individual unit tests for each procedure.}
\resumeItemListEnd
