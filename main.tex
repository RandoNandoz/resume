...
{BSc, Honours Computer Science and Software Engineering, Co-op}{September 2023 -- May 2028}
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \textbf{Developer Tools}{: Git, Docker, Azure, CloudFlare, Linux, Interactive Disassembler, Cisco Wireless, Hyper-V, VMware ESXi, Excel} \\
        \textbf{Libraries}{: Sympy, Numpy, Pandas, Matplotlib, MongoDB, jQuery, Catch, Flask, Swing/Java AWT, NUnit, JUnit, Unity, Power Apps Component Framework}}}
\end{itemize}
...
\resumeSubheading
{Research Assistant}{May 2025 -- Sept 2025}
...
% \resumeItem{Utilized program inspection tools in Python to read, .}
...
\resumeItem{Using PyTest, created high quality, repeated, and fast unit tests that complied with Assert-Arrange-Act testing practices to detect bugs early on in the development lifecycle.}
\resumeItemListEnd
...
\resumeItem{Achieved an average rating of 4.9/5 for student engagement, preparation, and fostering a positive learning environment.}
\resumeItemListEnd
...
{\href{}{\textbf{ExploTest}} $|$ \emph{Python, static and dynamic program analysis}}{Sept 2025}
\resumeItemListStart
...
\resumeProjectHeading
{\href{}{\textbf{Collidy Road}} $|$ \emph{Unity, C\#, .NET}}{July 2023}
\resumeItemListStart
\resumeItem{Achieved 95th percentile rated game quality, voted on by other contestants in the game jam.}
\resumeItem{Developed player and hostile entity play scripts in C\#.}
\resumeItem{Optimized game logic for large hostile entity count.}
\resumeItemListEnd
